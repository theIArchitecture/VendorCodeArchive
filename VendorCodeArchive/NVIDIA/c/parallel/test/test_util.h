...
// SEVERITY: FATAL
// ISSUES FOUND (2):
//   1. Line 661: CUDA memory allocation without corresponding free - potential memory leak
//   2. Line 667: CUDA memory allocation without corresponding free - potential memory leak
