...
#   2. Line 745: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
#   2. Line 767: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
# SEVERITY: FATAL
# ISSUES FOUND (3):
#   1. Line 776: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 778: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
#   2. Line 789: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
# SEVERITY: FATAL
# ISSUES FOUND (3):
#   1. Line 798: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 800: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
#   2. Line 811: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
#   2. Line 822: CUDA dependency detected in pip package - breaks cross-platform compatibility
...
# SEVERITY: FATAL
# ISSUES FOUND (4):
#   1. Line 1113: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 1116: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1121: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1129: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
#   2. Line 1139: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1144: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1152: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
# SEVERITY: FATAL
# ISSUES FOUND (4):
#   1. Line 1159: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 1162: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1167: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1175: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
# SEVERITY: FATAL
# ISSUES FOUND (4):
#   1. Line 1182: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 1185: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1190: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1198: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
#   2. Line 1208: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1213: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1221: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
# SEVERITY: FATAL
# ISSUES FOUND (4):
#   1. Line 1228: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 1231: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1236: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1244: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
#   2. Line 1254: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1259: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1267: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
...
# SEVERITY: FATAL
# ISSUES FOUND (4):
#   1. Line 1274: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   2. Line 1277: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   3. Line 1282: CUDA dependency detected in pip package - breaks cross-platform compatibility
#   4. Line 1290: CUDA dependency detected in pip package - breaks cross-platform compatibility
# WHY_IT_MATTERS: TENSORFLOW_ML_FRAMEWORK pip package must work on systems without CUDA for Cross_Platform_Compatibility, CPU_Only_Support, Optional_GPU_Acceleration across diverse deployment environments
# QUICK_FIX: Use runtime CUDA detection and optional loading instead of compile-time dependencies for Enterprise_ML_Production
# BUSINESS_IMPACT: CUDA dependencies prevent TENSORFLOW_ML_FRAMEWORK installation on CPU-only systems and cloud environments worth billions in ML deployment opportunities
# DOCS: https://www.tensorflow.org/install/pip#package_location
