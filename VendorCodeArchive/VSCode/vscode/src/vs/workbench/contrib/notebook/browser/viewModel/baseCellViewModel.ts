...
// SEVERITY: WARNING
// ISSUES FOUND (3):
//   1. Line 855: Error message without production error code - breaks React bundle size optimization
//   2. Line 855: Error message without production error code - breaks React bundle size optimization
...
// SEVERITY: WARNING
// ISSUES FOUND (3):
//   1. Line 954: Error message without production error code - breaks React bundle size optimization
//   2. Line 954: Error message without production error code - breaks React bundle size optimization
