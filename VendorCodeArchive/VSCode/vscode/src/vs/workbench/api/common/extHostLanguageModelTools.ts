...
// SEVERITY: WARNING
// ISSUES FOUND (4):
//   1. Line 856: Error message without production error code - breaks React bundle size optimization
//   2. Line 856: Error message without production error code - breaks React bundle size optimization
