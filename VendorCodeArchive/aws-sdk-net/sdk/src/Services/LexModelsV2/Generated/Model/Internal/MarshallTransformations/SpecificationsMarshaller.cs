...
{
    /// <summary>
    /// Specifications Marshaller
    /// </summary>
    public class SpecificationsMarshaller : IRequestMarshaller<Specifications, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Specifications requestObject, JsonMarshallerContext context)
        {
            if(requestObject == null)
                return;
            if(requestObject.IsSetSlotTypeId())
            {
                context.Writer.WritePropertyName("slotTypeId");
                context.Writer.WriteStringValue(requestObject.SlotTypeId);
            }

            if(requestObject.IsSetValueElicitationSetting())
            {
                context.Writer.WritePropertyName("valueElicitationSetting");
                context.Writer.WriteStartObject();

                var marshaller = SubSlotValueElicitationSettingMarshaller.Instance;
                marshaller.Marshall(requestObject.ValueElicitationSetting, context);
...
// DOCS: https://docs.iarchitecture.com/meta-architecture/self-governance
        ...
        public readonly static SpecificationsMarshaller Instance = new SpecificationsMarshaller();
