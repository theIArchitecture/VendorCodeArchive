...
# SEVERITY: WARNING
# ISSUES FOUND (2):
#   1. Line 669: Print statements detected in TensorFlow code - must use logging module for production code
#   2. Line 669: Print statements detected in TensorFlow code - must use logging module for production code
