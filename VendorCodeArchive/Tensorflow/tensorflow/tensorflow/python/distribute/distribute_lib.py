...
# SEVERITY: WARNING
# ISSUES FOUND (2):
#   1. Line 423: Print statements detected in TensorFlow code - must use logging module for production code
...
# SEVERITY: WARNING
# ISSUES FOUND (2):
#   1. Line 435: Print statements detected in TensorFlow code - must use logging module for production code
