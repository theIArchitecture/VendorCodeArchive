...
# SEVERITY: WARNING
# ISSUES FOUND (3):
#   1. Line 61: Print statements detected in TensorFlow code - must use logging module for production code
#   2. Line 61: Print statements detected in TensorFlow code - must use logging module for production code
