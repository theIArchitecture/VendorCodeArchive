...
#   5. Line 51: Print statements detected in TensorFlow code - must use logging module for production code
#   6. Line 51: Print statements detected in TensorFlow code - must use logging module for production code
#   7. Line 55: Print statements detected in TensorFlow code - must use logging module for production code
#   8. Line 55: Print statements detected in TensorFlow code - must use logging module for production code
#   9. Line 61: Print statements detected in TensorFlow code - must use logging module for production code
#   10. Line 61: Print statements detected in TensorFlow code - must use logging module for production code
